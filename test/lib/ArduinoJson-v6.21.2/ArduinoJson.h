// ArduinoJson-v6.21.2 - https://arduinojson.org
...
#  error ArduinoJson-v6.21.2 requires C++11 or newer. Configure your compiler for C++11 or downgrade ArduinoJson-v6.21.2 to 6.20.
#endif
...
ARDUINOJSON_END_PRIVATE_NAMESPACE
#ifndef strlen_P
inline size_t strlen_P(ArduinoJson-v6.21.2::detail::pgm_p s) {
...
#endif
#ifndef strncmp_P
inline int strncmp_P(const char* a, ArduinoJson-v6.21.2::detail::pgm_p b, size_t n) {
  const char* s1 = a;
...
#endif
#ifndef strcmp_P
inline int strcmp_P(const char* a, ArduinoJson-v6.21.2::detail::pgm_p b) {
  const char* s1 = a;
  const char* s2 = b.address;
  ARDUINOJSON_ASSERT(s1 != NULL);
  ARDUINOJSON_ASSERT(s2 != NULL);
...
#endif
#ifndef memcmp_P
inline int memcmp_P(const void* a, ArduinoJson-v6.21.2::detail::pgm_p b, size_t n) {
...
#endif
#ifndef memcpy_P
inline void* memcpy_P(void* dst, ArduinoJson-v6.21.2::detail::pgm_p src, size_t n) {
...
inline uint32_t pgm_read_dword(ArduinoJson-v6.21.2::detail::pgm_p p) {
  uint32_t result;
...
inline float pgm_read_float(ArduinoJson-v6.21.2::detail::pgm_p p) {
  float result;
...
inline double pgm_read_double(ArduinoJson-v6.21.2::detail::pgm_p p) {
...
#endif
#ifndef pgm_read_ptr
inline void* pgm_read_ptr(ArduinoJson-v6.21.2::detail::pgm_p p) {
  void* result;
...
#define ARDUINOJSON_ASSERT_INTEGER_TYPE_IS_SUPPORTED(T)                  \
  static_assert(sizeof(T) <= sizeof(ArduinoJson::JsonInteger),           \
                "To use 64-bit integers with ArduinoJson-v6.21.2, you must set " \
...
#define ARDUINOJSON_NAMESPACE _Pragma ("GCC warning \"ARDUINOJSON_NAMESPACE is deprecated, use ArduinoJson-v6.21.2 instead\"") ArduinoJson
#endif
...
#error ArduinoJson-v6.21.2 requires a C++ compiler, please change file extension to .cc or .cpp
